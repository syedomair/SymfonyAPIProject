 ...
 * @ORM\Entity(repositoryClass="SyedOmair\Bundle\AppBundle\Entity\ProductRepository")
 */
class Product
{
    /**
     ...
     *
     * @ORM\ManyToOne(targetEntity="SyedOmair\Bundle\AppBundle\Entity\Category")
     * @ORM\JoinColumns({
     ...
     * Set category
     *
     * @param \SyedOmair\Bundle\AppBundle\Entity\Category $category
     * @return Product
     */
    public function setCategory(\SyedOmair\Bundle\AppBundle\Entity\Category $category = null)
    {
     ...
     * Get category
     *
     * @return \SyedOmair\Bundle\AppBundle\Entity\Category 
     */
